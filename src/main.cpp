...
double CalculatePath(vector<double> & next_x_vals,
                     vector<double> & next_y_vals,
                     int previous_path_size,
                     vector<double> & ptsx,
                     vector<double> & ptsy,
                        ...
                        vector<double> & next_y_vals)
{
    ...
    DetermineStartingReference(car_x,
                               car_y,
                               car_yaw,
                               car_speed,
                               previous_path_x,
    ...
    vector<double> wp2;
    vector<double> wp3;
    SetWaypoints(map_waypoints_x, map_waypoints_y, map_waypoints_s, car_s, next_d, wp1, wp2, wp3);
    ...
    reference_velocity = CalculatePath(next_x_vals,
                                       next_y_vals,
                                       previous_path_size,
                                       ptsx,
                                       ptsy,
